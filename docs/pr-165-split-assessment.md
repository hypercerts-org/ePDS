...
| `email-autocomplete`             |                    3 | Medium — improves autofill and password-manager behavior      | Low — input attributes and mode toggle                      | Keep                                              |    P1    |
...
| `accessible-error-announcements` |                    4 | High — makes errors available to screen-reader users          | Low — standard alert/live-region semantics                  | Keep                                              |    P0    |
