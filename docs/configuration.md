...
| `EPDS_WALLET_ENABLED`             | When `1`, mounts the additive `/wallet` routes (enroll, create, info, sign, export, recover). Wallet keys live as 2-of-3 Shamir shares — fully separate from the repo flow; see the design doc. |
