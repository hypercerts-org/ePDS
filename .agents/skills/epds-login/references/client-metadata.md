...
| `email_template_uri`              | No          | URL to a custom OTP email HTML template. Trusted clients only. Must use HTTPS; HTTP is permitted only when `EPDS_ALLOW_PRIVATE_IPS=true` enables `allowHttp` for local development. Keep that setting disabled for internet-facing deployments.                                                                                                                                                                                                                                                                                                                                                                                                    |
