  ...
  <div class="layout">
    ...
    <div class="title-panel">
      <div class="title-panel-content">
        ${logoHtml}
        <h1 class="title">Sign in with Certified</h1>
    ...
    <main class="form-panel">
      ...
      <div id="step-otp" class="step-otp${opts.initialStep === 'otp' ? ' active' : ''}">
        ...
        <form id="form-verify-otp" class="form-group">
          ...
          <div class="otp-actions">
            <button type="submit" class="btn-primary">Sign In with Certified</button>
            <div class="otp-links">
  ...
  <script>
    (function() {
      ...
      document.getElementById('form-verify-otp').addEventListener('submit', async function(e) {
        ...
        btn.disabled = false;
        btn.textContent = 'Sign In with Certified';
      ...
      if (initialStep === 'otp' && loginHint) {
        ...
        if (!otpAlreadySent) {
          ...
          // Disable resend button to prevent double-send race condition.
